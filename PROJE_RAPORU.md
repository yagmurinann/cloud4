...
> 📸 **[EKLENECEK EKRAN GÖRÜNTÜSÜ 1]** 
> *Buraya AWS IAM konsolunda `yagmur` kullanıcısına ait izinlerin (Permissions) göründüğü ekran görüntüsünü ekleyin.*
...
> 📸 **[EKLENECEK EKRAN GÖRÜNTÜSÜ 2]** 
> *Buraya terminalde "Veri başarıyla S3'e yüklendi" yazısını gösteren log kaydının ekran görüntüsünü ekleyin.*
...
> 📸 **[EKLENECEK EKRAN GÖRÜNTÜSÜ 3]** 
> *Buraya terminalde "Model eğitimi (training) başlatılıyor..." ve "Starting the training job" kısımlarının olduğu ekran görüntüsünü ekleyin.*
...
> 📸 **[EKLENECEK EKRAN GÖRÜNTÜSÜ 4]** 
> *Buraya terminalde "Model SageMaker Endpoint olarak dağıtılıyor... Model başarıyla buluta dağıtıldı!" yazısının ekran görüntüsünü ekleyin.*
...
> 📸 **[EKLENECEK EKRAN GÖRÜNTÜSÜ 5]** 
> *Buraya terminaldeki "--- TAHMİN SONUÇLARI ---" listesinin (Tahmin Edilen Sınıf <---> Gerçek Sınıf) tamamının ekran görüntüsünü ekleyin.*
...
> 📸 **[EKLENECEK EKRAN GÖRÜNTÜSÜ 6]** 
> *Buraya terminalin en altındaki "Kullanılan kaynaklar (Endpoint) temizleniyor... Proje sonlandırıldı" sorusunun ve cevabının ekran görüntüsünü ekleyin.*
